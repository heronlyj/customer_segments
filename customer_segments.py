...
# **回答:**
# 
# 第一个样本鲜肉与冻肉比例很高，还有一定比例的熟肉与牛奶，但是杂货跟零食几乎没有，可以推测这个样本可能是家餐饮类的企业。
# 
# 第二个样本 #TODO: - 未完成
# 
#%% [markdown]
...
# TODO：输出在测试集上的预测得分 返回 R^2 score
...
# 为每一对新产生的特征制作一个散射矩阵
pd.plotting.scatter_matrix(log_data, alpha = 0.3, figsize = (14,10), diagonal = 'kde');
...
clusterer = GaussianMixture(n_components=2, covariance_type="full", random_state=42)
